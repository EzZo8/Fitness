  ...
  return (
    <div className='header'>
      ...
      {(menuOpen === false && mobile === true) ? (
        <div onClick={()=> setMenuOpen(!menuOpen)}> <img className='burger-img' src={Bars} alt='' /> </div>
      ) : (<ul className='header-menu'>
        <li ><Link onClick={()=> setMenuOpen(false)}to='home'span={true} smooth={true} activeClass='active'>Home</Link></li>
